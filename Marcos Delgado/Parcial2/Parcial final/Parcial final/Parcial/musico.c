...
int harcodearMusicos(Musico array[])
{

    Musico x[]=
    {

        //{"nombre", "apellido", edad,orquesta,instrumento},
        {1,0,"Mus1","Amus",30,1,2},
        {2,0,"Mus2","Amus",20,2,5},
        {3,0,"Mus3","Amus3",25,4,2},
        {4,0,"Mus4","Amus4",27,4,1},
        {5,0,"Mus5","Amus5",22,1,3},
        {6,0,"Mus6","Amus6",35,3,4},
    };
