...
int orquestas_CincoMusicos(Orquesta arrayOrquestas[], int sizeOrquesta,Musico arrayMusicos[], int sizeMusico); //incompleto

int orquesta_conMasMusicos(Orquesta arrayOrquestas[],int sizeOrquesta,Musico arrayMusico[],int sizeMusico); //incompleto

int orquesta_completa(Orquesta arrayOrquesta[],Musico arrayMusico[],Instrumento arrayInstrumento[],
                      int sizeOrquesta,int sizeMusico,int sizeInstrumento); //incompleto
